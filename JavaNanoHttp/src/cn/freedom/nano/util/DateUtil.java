...
public class DateUtil
{
	...
	/** ��ȡ����Date��ʵ�� */
	public final static DateUtil getLocalInstance()
	{
		return new DateUtil(Calendar.getInstance());
	}

	/** ָ��GMT��ʽ��Date */
	public final static DateUtil getInstance()
	{
		// Thanks for Theo Beisch (10/20/04)
		return new DateUtil(Calendar.getInstance(TimeZone.getTimeZone("GMT")));
	}
